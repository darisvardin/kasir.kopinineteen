...
//MENAMPILKAN DATA
$query = "SELECT produk. *, namakategori FROM produk LEFT JOIN kategori ON idkategori = kategori ORDER BY idproduk ASC";
                        ...
                        <tbody>
                          ...
                          do { ?>
                            <tr>
                              ...
                              <td>Rp. <?php echo number_format($row['hargadasar'], 0, ',', '.'); ?></td>
                              <td>Rp. <?php echo number_format($row['hargajual'], 0, ',', '.'); ?></td>
                              <td>
                                <div class="form-button-action">
                                  <button onclick="document.location='update.php?id=<?php echo $row['idproduk']; ?>'" type=" button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
                                    <i class="fa fa-edit">
                                    </i>
                                  </button>
                                  <a href="delete.php?id=<?php echo $row['idproduk']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ?')" type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
