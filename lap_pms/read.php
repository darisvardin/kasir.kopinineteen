...
//MENAMPILKAN DATA
// $query = "SELECT * FROM transaksi ORDER BY idtr ASC";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <button onclick="document.location='print.php?nota=<?php echo $row['nota']; ?>'" type=" button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-success btn-lg" data-original-title="Edit Task">
                                                                    <i class="fas fa-print">
                                                                    </i>
                                                                </button>
                                                                <button onclick="document.location='update.php?id=<?php echo $row['idtr']; ?>'" type=" button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
                                                                    <i class="fa fa-edit">
                                                                    </i>
                                                                </button>
                                                                <a href="delete.php?id=<?php echo $row['idtr']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ?')" type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
