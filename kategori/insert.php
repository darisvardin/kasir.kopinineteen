                ...
                <form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="namakategori" placeholder="Masukan Kategori" required />
                    </div>
                    <div class="form-group">
                      <label>Keterangan Kategori</label>
                      <input type="text" class="form-control" name="ketkategori" placeholder="Masukan Keterangan" />
                    </div>
