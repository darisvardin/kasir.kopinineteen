              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex align-items-center">
                    <h4 class="card-title">Ubah Data Kategori Produk</h4>
                  </div>
                </div>
                <form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="namakategori" value="<?php echo htmlentities($row['namakategori'], ENT_COMPAT, ''); ?>" />
                    </div>
                    <div class="form-group">
                      <label>Keterangan Kategori</label>
                      <input type="text" class="form-control" name="ketkategori" value="<?php echo htmlentities($row['ketkategori'], ENT_COMPAT, ''); ?>" />
                    </div>
                  ...
                  <input type="hidden" name="idkategori" value="<?php echo htmlentities($row['idkategori'], ENT_COMPAT, ''); ?>">
                </form>
              </div>
            </div>
          </div>
