...
//MENAMPILKAN DATA
$query = "SELECT  * FROM pembayaran ORDER BY idpembayaran ASC";
                        ...
                        <tbody>
                          ...
                          do { ?>
                            <tr>
                              ...
                              <td><?php echo $row['ketpembayaran']; ?></td>
                              <td>
                                <div class="form-button-action">
                                  <button onclick="document.location='update.php?id=<?php echo $row['idpembayaran']; ?>'" type=" button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
                                    <i class="fa fa-edit"></i>
                                  </button>
                                  <a href="delete.php?id=<?php echo $row['idpembayaran']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ?')" type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
